  ...
  template: `
    <mat-form-field fxFlex [formGroup]="form" [appearance]="field.appearance" [color]="field.color" [hideRequiredMarker]="false">
      ...
      <input #input="matInput"
             ...
             [type]="field.type">
      <button *ngIf="field.clearButton && input.value" matSuffix mat-icon-button aria-label="Clear" (click)="control.patchValue('')">
      ...
      <mat-error *ngIf="control.getError('email') as err">
